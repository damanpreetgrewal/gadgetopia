...
const ProfileThreeColGrid = ({
  ...
  cards = [
    {
      imageSrc: "https://i.imgur.com/Hcl4WNC.jpg",
      position: "Co-Founder",
    ...
    {
      imageSrc: "https://i.imgur.com/q2Wc0jU.jpg",
      position: "Co-Founder",
      name: "Jaivin Movaliya",
      links: [
        {
          url: "https://twitter.com",
          icon: TwitterIcon,
    ...
    {
      imageSrc: "https://i.imgur.com/BsWLXpD.jpg",
      position: "Co-Founder",
      name: "Gurleen Kaur",
      links: [
        {
    ...
    {
      imageSrc: "https://i.imgur.com/WHEfjlQ.jpg",
      position: "Co-Founder",
    ...
    {
      imageSrc: "https://i.imgur.com/9DtWw8r.jpg",
      position: "Co-Founder",
